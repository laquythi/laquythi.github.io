...
// 	char *p=strchr(str1,'i');//tim ky tu 'i' trong chuoi 'thi la quy';
// 	if(p!=NULL){
// 		cout<<"tim thay ky tu 'i' tai vi tri  "<<p-str1<<" trong chuoi";
//	}else{
//	 	cout<<"khong tim thay ky tu 'i' trong chuoi";
//	}
//	 
//	char str2[200];
...
//	}
	...
	char str1[40];
	strcpy(str1,"hellen tran");
	char *p = strchr(str1,'i');
	if(p!= NULL){
		cout<<"tim thay ky tu i tai vi tri "<<p-str1<<" trong chuoi str1";
	}else{
		cout<<"ko tim thay ky tu i trong chuoi str1";
	}
	return 0;
}
